...
public class OrderRepository {
	...
	public Order findByUserIdAndStatus(Integer userId, Integer status) {
		String sql = "SELECT"
				...
				+ " i.priceM as item_price_M,"
				+ " i.priceL as item_price_L,"
				+ " i.image_path as img_path,"
				+ " quantity,"
				+ " size,"
				+ " topping_id"
				+ " t.name as topping_name,"
				+ " t.priceM as topping_price_M,"
				+ " t.priceL as topping_price_L"
				+ " FROM"
				+ " orders as o"
				+ " LEFT OUTER JOIN orders_items as oi ON o.id = oi.order_id"
				+ " LEFT OUTER JOIN order_toppings as ot ON oi.id=ot.order_id"
				+ " JOIN items as i ON oi.item_id=i.id"
				+ " JOIN toppings as t ON ot.topping_id=t.id"
